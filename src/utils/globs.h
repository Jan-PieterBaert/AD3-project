...
#define NUMBER_OF_BTREE_KEYS MAX(2, 2*((CACHESIZE - 18)/32))
/* Our datastructure has 2+8+8*n+8*(n+1) bytes in size, the NUMBER_OF_BTREE_KEYS must be an even number, so this gives the above formula */
